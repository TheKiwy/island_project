...
public class Grille {
	...
	public Grille() {
		...
		tuiles.add(new Tuile(Role.recupZephyr, "Le Val du Crépuscule"));
		...
		tuiles.add(new Tuile(Role.porteGrise, "La Porte d'Argent"));
		tuiles.add(new Tuile(Role.recupZephyr, "Jardin des Hurlements"));
		...
		tuiles.add(new Tuile(Role.recupCalice, "Le Palais de Marées"));
		tuiles.add(new Tuile(Role.heliport, "L'Heliport"));
		...
		tuiles.add(new Tuile(Role.recupCalice, "Le Palais de Corails"));
